...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 000 ????? 00000 11", lb     , I, R(rd) = Mr(src1, 1) + imm);
  INSTPAT("0100000 ????? ????? 001 ????? 00000 11", lh     , I, R(rd) = Mr(src1, 2) + imm);
  INSTPAT("0100000 ????? ????? 010 ????? 00000 11", lw     , I, R(rd) = Mr(src1, 4) + imm);
